...
import { updateSubItemById } from '@/actions/subscriptions.actions'
...
export default function UpdateSubItemCard ({
  assets,
  benefits,
  id,
  name,
  ...
  return (
    <div className='flex flex-col justify-start gap-4 border-[1px] border-solid border-black py-4 w-full md:w-[20rem]'>
      ...
      <form action={updateSubItemById} className='px-4 flex flex-col justify-start gap-4'>
        ...
        <input value={id} readOnly type='hidden' name='subItem' />
        <Submit
          label='Update'
