  ...
  return (
    <section className='flex flex-col justify-start gap-7'>
      ...
      <section className='flex flex-col justify-start gap-2'>
        <div className='flex flex-col justify-start gap-2 pl-2 md:pl-0'>
      ...
      <section className='flex flex-col justify-start gap-2'>
        <div className='flex flex-col justify-start gap-2 px-2 md:pl-0'>
        ...
        <section
          ...
          className='h-96 relative flex justify-center'
        >
      ...
      <section className='flex flex-col justify-start gap-4 text-it-gray-1 mt-4'>
        <h1 className='text-center text-4xl font-bold'>Contact Sales</h1>
        <ul className='flex items-center justify-center gap-8 flex-wrap [&>li]:flex [&>li]:flex-col [&>li]:justify-start [&>li]:items-center [&>li]:gap-2 [&>li>a]:text-3xl [&>li>a]:font-bold'>
          <li>
